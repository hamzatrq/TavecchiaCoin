...
// Copyright (c) 2013 TavecchiaCoin developers
...
const string strMessageMagic = "TavecchiaCoin Signed Message:\n";
...
static const int64 nMinSubsidy = 0 * COIN;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TavecchiaCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TavecchiaCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("TavecchiaCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running TavecchiaCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("TavecchiaCoinMiner terminated\n");
        throw;
    }
}
